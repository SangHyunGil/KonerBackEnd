...
public class TestData {
    ...
    static class InitService {
        ...
        private void initStudy() {
            ...
            Study study = new Study("백엔드 모집", "백엔드", "백엔드 모집합니다.", "C:\\Users\\Family\\Desktop\\SH\\spring\\StudyProfile\\2.png", StudyState.STUDYING, RecruitState.PROCEED, 3L, "2021-12-25", member, new ArrayList<>(), new ArrayList<>());
