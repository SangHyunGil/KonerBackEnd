...
public class TestDB {
    ...
    private void initStudy() {
        ...
        Study study = new Study("백엔드 모집", new Tags(List.of(new Tag("백엔드"), new Tag("JPA"), new Tag("스프링"))), "백엔드 모집합니다.", "C:\\Users\\Family\\Pictures\\Screenshots\\2.png", StudyCategory.CSE, new StudyOptions(StudyState.STUDYING, RecruitState.PROCEED, StudyMethod.FACE), 5L, new Schedule("2021-10-01", "2021-12-25"), storedMemberA, new ArrayList<>(), new ArrayList<>());
