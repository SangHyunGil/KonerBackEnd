...
public class TestDB {
    ...
    private void initStudy() {
        ...
        Study study = new Study("백엔드 모집", "백엔드", "백엔드 모집합니다.", "C:\\Users\\Family\\Pictures\\Screenshots\\2.png", StudyState.STUDYING, RecruitState.PROCEED, 4L, "2021-12-25", memberA, new ArrayList<>(), new ArrayList<>());
